...
const EditProfile = () => {
    ...
    //         if (email !== userData.email || passwords.newPassword) {
    ...
    //         console.log("User email2", userData.email);

    //         // Update the email if it has changed
    //         if (email !== userData.email) {
    //             console.log("Attempting to update email to:", email); // Console log before updating email
    //             await updateEmail(auth.currentUser, email as string); // Update email in Firebase Authentication
    //             console.log("Email updated successfully!"); // Log after successful update
