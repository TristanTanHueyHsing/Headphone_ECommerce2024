      ...
      <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-16">
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-10">
          ...
          <div className="text-start flex-1">
            ...
            Immerse yourself in a world of pure audio bliss. Our carefully curated selection of headphones caters to every listener, from the casual audiophile to the discerning music enthusiast. Whether you prefer the convenience of wireless freedom or the fidelity of wired connections, we have the perfect pair to elevate your auditory experience. Thank you for choosing to shop with us.
            </p>
          </div>
        </div>
